  ...
  return (
    <div className='bg-backgroundGreen flex h-screen'>
      ...
      <div className="w-full sm:w-3/4 ml-0 h-full sm:ml-64">
        ...
        <div className='flex'>
        <h1 className='ml-8 mb-8 mt-24 lg:mr-[860px] h-4 text-3xl font-semibold text-sidebarGreen left-0'>
           Videos
        </h1>
        ...
        <h1 className='ml-8 mb-8 mt-4 lg:mr-[830px] h-4 text-3xl font-semibold text-sidebarGreen left-0'>
                  Products
                </h1>
