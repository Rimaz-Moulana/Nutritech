...
export default function LogTable({ Products }) {
  ...
  const filterKeys = ['_id', 'createdIn', 'createdAt', '__v', 'imageLeft', 'imageRight', 'imageFront', 'imageBack', 'videoPath'];
    ...
    <div className='w-full sm:text-sm sm:p-2'>
      ...
      >
        {selectedProductIndex !== null && (
          <div className="bg-white mt-20 rounded-lg p-4 w-full max-w-7xl">
