  ...
  return (
    <>
      ...
      {showModal ? (
        <>
          <div
            className="flex justify-end text-left overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none"
          >
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                {/*footer*/}
                <div className="flex items-right justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
                  <button
                  ...
                  <button
                    className="bg-[#3C6339] text-white active:bg-[#3C6339]-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
                    onClick={() => setShowModal(false)}
                  >
                    Save Changes
